...
object AccessModifiers {
  ...
  class Person(val name: String) {
    ...
    private def watchNetflix(): String = "I'm binge watching my favorite series..." // only accessible inside the class
  }

  // protected == access to inside the class + child classes
